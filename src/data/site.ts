...
export const projects = [
  ...
  {
    title: 'Monitoreo Vehicular Inteligente',
    category: 'Web Application',
    filter: 'web',
    copy: `Aplicación web desarrollada con React y TypeScript que integra la API de Traccar para monitorear 
    vehículos en tiempo real. Incluye visualización de telemetría GPS, mapa interactivo y estados de carga.`,
    tags: ['React', 'TypeScript', 'Traccar API', 'UX/UI'],
    href: 'https://vehicle-control-room.vercel.app/',
    image: '/images/project-traccar.png',
  },
  {
